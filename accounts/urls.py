...
urlpatterns = [
    ...
    path('serviceprovider/registration/', ServiceProviderRegistrationView.as_view(), name='service-provider-registration'),
    ...
    path('serviceprovider/change-password/', ServiceProviderChangePasswordView.as_view(), name='service-provider-change-password'),
    path('serviceprovider/logout/', LogoutView.as_view(next_page=reverse_lazy('accounts:service-provider-login')), name='service-provider-logout'),
]
